...
layui.config({
    base: $("#contextPath").val()+'/layui/js/cropper/' //layui自定义layui组件目录
}).define(['jquery', 'layer', 'cropper'], function (exports) {
    var $ = layui.jquery
        , layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\""+$("#contextPath").val()+"/layui/js/cropper/cropper.css\">\n" +
