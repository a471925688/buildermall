...
;layui.define(["layer", "laytpl", "upload"], function(i) {
  ...
  var u = function(i) {
    ...
    item: "item.list",
    index: "index"
  }), "</ul>", "</li>", "{{# }); if(d.friend.length === 0){ }}", '<li><ul class="layui-layim-list layui-show"><span class="layim-null">暂无联系人</span></ul>', "{{# } }}", "</ul>", '<ul class="layui-unselect layim-tab-content {{# if(!d.base.isfriend && d.base.isgroup){ }}layui-show{{# } }}">', "<li>", '<ul class="layui-layim-list layui-show layim-list-group">', u({
    type: "group"
    ...
    j[i.type] && ("friend" === i.type ? layui.each(j.friend, function(e, t) {
      layui.each(t.list, function(t, n) {
        if (i.id == n.id) {
          ...
          0 === j.friend[e].list.length && l.find(".layui-layim-list").html('<span class="layim-null">该分组下已无好友了</span>'),
              !0
        }
      })
